...
dfuf = df.groupby(['DESDRTCLLATU', 'CODESTUNI'])[['VLRVNDFATLIQ', 'VLRRCTLIQAPU', 'VLRMRGBRT', 'VLRMRGCRB']].sum().reset_index()

print('Confere FTOOCDMTZRCTCMP')
print(dfuf.to_markdown(index=False, tablefmt='github', floatfmt=',.2f', numalign='right'))
