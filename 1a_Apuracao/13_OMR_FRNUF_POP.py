...
with open('../Parametros/caminho.txt','r') as f:
    caminho = f.read()
DIVFRN_UF = pd.read_feather(caminho + 'bd/DIVFRN_UF.ft')
...
OMR_FRNUF.reset_index(drop=True, inplace=True)
